...
def test_ashby_regression(monkeypatch):
    def dummy_get(url):
        class DummyResp:
...
def test_smartrecruiters_regression(monkeypatch):
    def dummy_get(url):
        class DummyResp:
            def raise_for_status(self): pass
            def json(self):
...
def test_workable_regression(monkeypatch):
    def dummy_get(url):
        class DummyResp:
            def raise_for_status(self): pass
            def json(self):
...
def test_recruitee_regression(monkeypatch):
    def dummy_get(url):
        class DummyResp:
            def raise_for_status(self): pass
            def json(self):
