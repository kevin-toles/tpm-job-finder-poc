...
def test_cli_pipeline_end_to_end():
    ...
    sample_jobs = os.path.join(base_dir, 'cross_component_tests', 'fixtures', 'remoteok_sample.json')
    sample_resume = os.path.join(base_dir, 'cross_component_tests', 'fixtures', 'sample_resume.txt')
    sample_applied = os.path.join(base_dir, 'cross_component_tests', 'fixtures', 'sample_applied.xlsx')
