	...
	def _normalize_jobs(self, data):
		...
		for item in data.get("jobs", []):
			...
			try:
				...
				handle_error(e, context={'component': 'greenhouse', 'method': '_normalize_jobs', 'posted': posted})
		...
		for company in self.companies:
			...
			for item in data.get("jobs", []):
				...
				try:
					...
					handle_error(e, context={'component': 'greenhouse', 'method': 'fetch_since', 'posted': posted})
					date_posted = None
